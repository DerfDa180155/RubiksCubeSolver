...
class RubiksCubeSolver:
    ...
    def PLLSolver(self):
        ...
        pll1.append([self.front[1][2] == self.back[0][0] and self.front[1][2] == self.back[2][0] and self.back[1][0] == self.front[0][2] and self.back[1][0] == self.front[2][2] and self.right[0][1] == self.left[2][0] and self.right[0][1] == self.left[2][2] and self.left[2][1] == self.right[0][0] and self.left[2][1] == self.right[0][2], ["M", "M", "D", "M", "M", "D", "D", "M", "M", "D", "M", "M"]]) # PLL (H)
        pll1.append([self.right[0][1] == self.left[2][0] and self.right[0][1] == self.left[2][2] and self.left[2][1] == self.back[0][0] and self.left[2][1] == self.back[2][0] and self.back[1][0] == self.right[0][0] and self.back[1][0] == self.right[0][2], ["R", "D'", "R", "D", "R", "D", "R", "D'", "R'", "D'", "R", "R"]]) # PLL (Ua)
